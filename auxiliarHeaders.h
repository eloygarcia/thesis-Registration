...
// typdef
typedef itk::Image<float, 3> ImageMriType;

typedef itk::Image<float,3> Image3floatType;
typedef itk::Image<unsigned short,2> Image2floatType;
...
typedef itk::ImportImageFilter<unsigned short, 3> ImportFloatImageFilterType;
